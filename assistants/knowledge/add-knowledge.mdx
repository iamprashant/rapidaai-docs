...
<CardGroup cols={2}>
  <Card title="Created a Knowledge Source" icon="book" href="/knowledge/create-knowledge">
    Learn how to create a knowledge source in our guide.
  </Card>
  <Card title="Created an Assistant" icon="bot" href="/assistants/create-assistant">
