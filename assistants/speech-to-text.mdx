...
| VAD | Silero VAD with balanced confidence and 0.2s start/stop windows. |
...
|---------|--------------|----------------|
| Transcripts miss quiet speech | VAD confidence too high or wrong STT model | Lower VAD confidence and test another STT model. |
| Transcripts include background noise | Noise cancellation off or VAD too sensitive | Enable RNNoise and raise VAD confidence. |
| User words are cut off at the beginning | VAD speech confirmation too strict | Reduce VAD start seconds or lower VAD confidence. |
