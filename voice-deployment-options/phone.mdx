...
<Steps>
  ...
  <Step title="Voice Input (Speech-to-Text)">
    ...
    **Voice Activity Detection (VAD)**
    ...
    - **VAD Confidence** — Speech probability required for detection (default: 0.7). Higher values require more confident speech detection
    - **VAD Start/Stop Seconds** — Continuous speech/non-speech duration used to confirm speech boundaries (default: 0.2s each)
