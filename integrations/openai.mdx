...
<CardGroup cols={2}>
  <Card title="Create Assistant" icon="robot" href="/assistants/openai">
    <p className="text-sm mt-2 leading-none">
      Build AI assistants using OpenAI's language models.
    </p>
  </Card>
  <Card
    title="Create Analyzer"
    icon="magnifying-glass-chart"
    href="/analyzers/openai"
  >
    <p className="text-sm mt-2 leading-none">
      Develop analyzers with OpenAI to extract insights from your data.
    </p>
  </Card>
</CardGroup>
