...
<CardGroup cols={2}>
  <Card title="Create Assistant" icon="robot" href="/assistants/azure-openai">
    <p className="text-sm mt-2 leading-none">
      Build AI assistants using Azure OpenAI's advanced language models.
    </p>
  </Card>
  <Card
    title="Create Analyzer"
    icon="magnifying-glass-chart"
    href="/analyzers/azure-openai"
  >
    <p className="text-sm mt-2 leading-none">
      Develop analyzers with Azure OpenAI to extract insights from your data.
    </p>
  </Card>
</CardGroup>
