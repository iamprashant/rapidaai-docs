...
<CardGroup cols={2}>
  <Card title="Create Assistant" icon="robot" href="/assistants/google-ai">
    <p className="text-sm mt-2 leading-none">
      Build AI assistants using Google AI's advanced language models.
    </p>
  </Card>
  <Card
    title="Create Analyzer"
    icon="magnifying-glass-chart"
    href="/analyzers/google-ai"
  >
    <p className="text-sm mt-2 leading-none">
      Develop analyzers with Google AI to extract insights from your data.
    </p>
  </Card>
</CardGroup>
