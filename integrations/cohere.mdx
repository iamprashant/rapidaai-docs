...
<CardGroup cols={2}>
  <Card title="Create Assistant" icon="robot" href="/assistants/cohere">
    <p className="text-sm mt-2 leading-none">
      Build AI assistants using Cohere's advanced language models.
    </p>
  </Card>
  <Card
    title="Create Analyzer"
    icon="magnifying-glass-chart"
    href="/analyzers/cohere"
  >
    <p className="text-sm mt-2 leading-none">
      Develop analyzers with Cohere to extract insights from your data.
    </p>
  </Card>
</CardGroup>
