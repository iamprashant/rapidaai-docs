...
2. Select the embedding model provider you want to use (e.g., OpenAI, Cohere, Hugging Face).
...
<Steps>
  ...
  <Step title="Select Embedding Model">
    Click the dropdown menu and select an appropriate embedding model for your knowledge base.
