...
Choose the deployment method that best suits your infrastructure and requirements:
- [Local/VM (Docker Compose)](#localvm-docker-compose) - Quickest way to get started
