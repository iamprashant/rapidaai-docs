...
| `InterruptionPacket` (VAD start) | Speech onset detected — block EOS completion while VAD is active |
| `InterruptionPacket` (VAD end) | Speech offset detected — flush pending EOS if transcript exists |
